  ...
  export default {
    ...
    methods:{
      ...
      handleObjectClick(path){
        ...
        var params={roleLevel:3,paperId:this.paperId,sno:this.getParams.username};
        /*queryStuPaper(params)*/
        var obj={
          "knowledgeCover": [
            "知识点覆盖面"
          ],
      ...
      getTable(){
        const params=Object.assign({},this.defaultParams,this.form,{paperState:1,sno:this.getParams.username});
        this.tableData=[
